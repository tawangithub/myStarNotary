...
contract StarNotary is ERC721, ERC721Metadata {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(token1Owner == msg.sender || token2Owner == msg.sender, "The sender must be the owner of either token1 or token2");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == token1Owner, "The sender must be the owner of the token");
